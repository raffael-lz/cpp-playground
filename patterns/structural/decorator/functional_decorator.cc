...
struct Logger_3
{
    ...
    Logger_3(const std::function<double(double,double)>& func, const std::string name)
        : func_(func), name_(name)
    {
    }
...
auto make_shared_3(const std::function<double(double, double)>& func, const std::string& name)
{
